...
Ported from claude-code-my-workflow/.claude/hooks/log-reminder.py (self-contained,
stdlib only). Session logs for this repo live in quality_reports/session_logs/.
